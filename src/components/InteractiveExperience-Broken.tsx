...
export default function InteractiveExperience() {
  ...
  // Debug logging
  console.log('Experience sections:', experience.sections.length)
  console.log('Active section:', activeSection)
  console.log('Available sections:', experience.sections.map((s, i) => ({ index: i, title: s.title, experiences: s.experiences.length })))
  ...
  // Ninja-themed tab names
  const ninjaTabNames = [
    "Current Dojo", // Current Employer
    "Shadow Training", // Internships  
    "Missions" // Leaderships
  ]
            ...
            >
              {experience.sections[activeSection]?.experiences?.map((exp, index) => {
                ...
                <div className="text-center text-ninja-gray dark:text-ninja-silver p-8">
                  ...
                  <p>Available sections: {experience.sections.length}</p>
                </div>
              )}
            </motion.div>
          </AnimatePresence>
